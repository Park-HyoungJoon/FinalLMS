...
@Log4j2
public class LectureControllerLinux {
    ...
    public String LectureAdd(@ModelAttribute LectureAddDto lectureAddDto, Model model) throws IOException,
        ...
        try {
            ...
            File saveFile = new File(resourcePath,uuidFileName);
            ...
            if (lectureAddDto.getThisId() == null) {
                ...
                return "lecture/lectureContentsEdit/"+lectureDivide2.getId();
            } else {
                ...
                try {
                    ...
                    return "lecture/lectureContentsEdit"+lectureDivideIds.get(0);
    ...
    public String ContentsFileCreate(FileVO fileVO)
            throws IOException {
        String resourcePath = "/home/phj/video/";
        ...
        try{
            ...
            for (LectureContents lectureContents : lectureContentsList2){
                ...
                LectureContentsFile lectureContentsFile = lectureContentsService.getLectureContentsFileByLectureContents(lectureContents);
                File file = new File(resourcePath,lectureContentsFile.getFileName());
                if(file.exists()){
                    file.delete();
                }
            }}catch (Exception e){
    ...
    public String deleteLecture
        ...
        try{
            ...
            for(LectureDivide lectureDivide : lectureDivideList){
                ...
                for(LectureContents lectureContents : lectureContentsList){
                    LectureContentsFile lectureContentsFile = lectureContentsService.getLectureContentsFileByLectureContents(lectureContents);
                    File existFile = new File(resourcePath,lectureContentsFile.getFileName());
                    if(existFile.exists()){
                        existFile.delete();
                    }
                }
